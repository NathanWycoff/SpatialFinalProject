...
alpha <- 0.05#Bonding Coefficient
...
R <- matrix(rep(5, x_size * t_size), nrow = x_size)#Initialize a matrix of zeros
...
#R[36,1] <- 200#Enforc0e Initial Conditions, point mass at 25
...
plot(hyper_results$N, hyper_results[,1], type='l', col = 'red', 
     ...
     main = 'Comparison of Methods for Model with Structural Error')
